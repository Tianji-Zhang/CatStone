...
J_info(2). J_eqn{1}=@(cell_index,var_array,dim)(100-var_array(1,cell_index));
J_info(2). J_eqn{2}=@(cell_index,var_array,dim)(100-(var_array(1,cell_index)+(50.*(1-var_array(2,cell_index)))));
J_info(3). J_eqn{1}=@(cell_index,var_array,dim)var_array(1,cell_index);
J_info(3). J_eqn{2}=@(cell_index,var_array,dim)(var_array(1,cell_index)+(50.*(1-var_array(2,cell_index))));
...
J_info(2). dJdv_i{1,1}=@(cell_index,var_array,dim)-1;
J_info(2). dJdv_i{2,1}=@(cell_index,var_array,dim)-1;
J_info(2). dJdv_i{1,2}=@(cell_index,var_array,dim)0;
J_info(2). dJdv_i{2,2}=@(cell_index,var_array,dim)50;
J_info(3). dJdv_i{1,1}=@(cell_index,var_array,dim)1;
J_info(3). dJdv_i{2,1}=@(cell_index,var_array,dim)1;
J_info(3). dJdv_i{1,2}=@(cell_index,var_array,dim)0;
J_info(3). dJdv_i{2,2}=@(cell_index,var_array,dim)-50;
...
J_info(2). dJdv_adj{1,1}=@(cell_index,var_array,dim)0;
J_info(2). dJdv_adj{2,1}=@(cell_index,var_array,dim)0;
J_info(2). dJdv_adj{1,2}=@(cell_index,var_array,dim)0;
J_info(2). dJdv_adj{2,2}=@(cell_index,var_array,dim)0;
J_info(3). dJdv_adj{1,1}=@(cell_index,var_array,dim)0;
J_info(3). dJdv_adj{2,1}=@(cell_index,var_array,dim)0;
J_info(3). dJdv_adj{1,2}=@(cell_index,var_array,dim)0;
J_info(3). dJdv_adj{2,2}=@(cell_index,var_array,dim)0;
...
Solution = NRsolver(num_var, num_cell, num_dim,J_info, S_info, O_info,var_n,dt,t);
